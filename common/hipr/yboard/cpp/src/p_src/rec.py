  ...
  for key in m:
    if key.startswith('hhhh') or key.startswith('vvvv'):
      ...
      if int(m[key][1]) !=0:
        ...
        plt.text(float(m[key][2]), yc-0.2, key, fontsize=20, color='purple')
...
if __name__ == '__main__':
  ...
  parser.add_argument('-i', '--file_in',  help="default: freqence", type=str, default='./position.txt')
  parser.add_argument('-d', '--device',   help="device name",       type=str, default='yboard')
