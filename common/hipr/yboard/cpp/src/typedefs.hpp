...
using namespace std;
  ...
  #define TRIAL_NUM1       10000000                 // Default trial number per log-scale unit
  ...
  #define INST_NAME1       "level0_i/ulp/increment_1/mono_inst/data_proc1_inst"         // default instance prefix for xdc generation. <"level0_i/ulp", "pfm_top_i/dynamic_region">
  ...
  #define SAFE_GAP         1                      // The minimum columns gap between 2 PR Regions to place Relay_Station/Skid_buffer
  ...
  #define MILP_MAX_TIME    0                      // Set the Mixed Integer Programming maximum runtime. value 0 dienables this set
