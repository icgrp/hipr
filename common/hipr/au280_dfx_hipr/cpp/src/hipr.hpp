...
Design Name  : the HIPR class for floorplan
Project Name : HIPR
Versions     : 1.02
Dependencies : C++
...
public:
	...
	double          t_init;
	double          t_min;
	int             trial_num_per_0p1;                  // trial number per 0.1 smaller temperature
	int             number_per_iter;                    // trial number per temperature update
	...
	void dump_result(bool isSuccess);
