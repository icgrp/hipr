...
for line in file_in:
  if copy_enable:
    if (line.replace('add_files', '') != line):
      ...
      file_out.write('# ' + line)
      file_out.write('add_files ../../../../../../../../../../'+str(F001_dir)+'/au280_dfx_hipr/checkpoint/hw_bb_divided.dcp\n')
      ...
      file_out.write('# ' + line)
      file_out.write('link_design -mode default -part xcu280-fsvh2892-2L-e -reconfig_partitions {level0_i/ulp/increment_1/mono_inst/data_proc1_inst } -top level0_wrapper\n')
